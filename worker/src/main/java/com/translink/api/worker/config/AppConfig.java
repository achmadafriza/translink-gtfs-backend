package com.translink.api.worker.config;

import com.fasterxml.jackson.databind.module.SimpleModule;
import com.google.maps.GeoApiContext;
import com.translink.api.worker.config.format.SpecializedTimeSerializer;
import com.translink.api.worker.config.format.model.SpecializedTime;
import com.translink.api.worker.config.format.SpecializedTimeFormatter;
import com.translink.api.worker.config.format.converter.SpecializedTimeReadConverter;
import com.translink.api.worker.config.format.converter.SpecializedTimeWriteConverter;
